...
const PresetTargetCard = ({
  ...
  return (
    <div className="bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.06] rounded-lg p-5">
      <h4 className="text-sm font-semibold text-accent-600 dark:text-accent-400 mb-1">
        Target Profile
      </h4>
